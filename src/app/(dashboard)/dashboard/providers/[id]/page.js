...
import { Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, XiaomiMimoAuthModal, IFlowCookieModal, GitLabAuthModal, Toggle, Select, EditConnectionModal, NoAuthProxyCard, OpenCodeTlsCard, ConfirmModal } from "@/shared/components";
    ...
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:gap-8 sm:px-0">
      ...
      {isFreeNoAuth ? (
        <>
          ...
          {providerId === "opencode" && <OpenCodeTlsCard />}
        </>
      ) : (
        <Card>
