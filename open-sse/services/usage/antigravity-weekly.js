...
import { ANTIGRAVITY_HEADERS, INTERNAL_REQUEST_HEADER } from "../../config/appConstants.js";

// — Weekly quota summary config ——————————————————————————————
// Fork: same CLI fingerprint + MITM anti-loop flag as the other quota calls
// (google.js). The IDE UA is only for web-search, never for API traffic.
const WEEKLY_CONFIG = {
  ...U("antigravity"),
